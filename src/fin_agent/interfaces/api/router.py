...
def build_router() -> APIRouter:
    ...
    @router.get(
        '/v1/skills/details', response_model=SkillDetailsResponse, tags=['skills']
    )
    ...
    @router.post(
        '/v1/skills/install', response_model=SkillMutationResult, tags=['skills']
    )
    def install_skill(
        payload: InstallSkillRequest, request: Request
    ) -> SkillMutationResult:
        ...
        try:
            installed = skill_installer.install_from_url(
                payload.url, container.external_skills_dir
            )
    ...
    @router.post(
        '/v1/skills/upload', response_model=SkillMutationResult, tags=['skills']
    )
    ...
    @router.delete(
        '/v1/skills/{name}', response_model=SkillMutationResult, tags=['skills']
    )
    def delete_skill(name: str, request: Request) -> SkillMutationResult:
        ...
        try:
            skill_installer.uninstall(
                name, container.external_skills_dir, BUILTIN_SKILLS_DIR
            )
    ...
    @router.post(
        '/v1/skills/reload', response_model=SkillMutationResult, tags=['skills']
    )
